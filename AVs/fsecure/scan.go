...
func AvScan(timeout int) FSecure {
	...
	// Declaring vars for the scan command for added readability
	scanCommand := "/opt/f-secure/fsav/bin/fsav"
	scanCommandOptions := "--virus-action1=none"
...
func updateAV(ctx context.Context) error {
	...
	updateCommand := "/opt/malice/update"
